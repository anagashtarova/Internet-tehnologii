...
namespace Lab3_IT_186001.Controllers
{
    public class FriendModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,MestoZiveenje")] FriendModel friendModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,MestoZiveenje")] FriendModel friendModel)
        {
            if (ModelState.IsValid)
            {
